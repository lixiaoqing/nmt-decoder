...
Decoder::Decoder()
{
    load_params(d_params);
    load_dict(src_w2i,tgt_i2w);
...
void Decoder::load_params(map<string,float*> &d_params)
{
...
void Decoder::load_dict(map<string,int> &src_w2i,map<int,string> &tgt_i2w)
{
    string s;
